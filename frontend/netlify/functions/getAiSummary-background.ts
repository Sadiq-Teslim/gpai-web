...
// Twilio REST client for sending proactive messages
...
export const handler: Handler = async (event) => {
  ...
  // Define the Twilio Sandbox number
  ...
  // --- Store the extracted courses in Supabase for confirmation ---
  // We'll update the 'users' table with a temporary column for this.
  // Make sure you add a column named 'ocr_data' of type 'jsonb' to your 'users' table in Supabase.
